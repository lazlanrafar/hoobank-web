    ...
    >
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h2 className="text-white flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px]">
        ...
        <h2 className="text-white font-poppins font-semibold ss:text-[64px] text-[52px] ss:leading-[100px] leading-[75px] w-full">
          Payment Method.
        </h2>
